...
import { buildTown, isWalkable, tileToWorld, TILE } from './town'
import { buildPerson, RESIDENTS, type Resident } from './people'
...
function tryStep(dx: number, dz: number) {
...
// ---------------------------------------------------------------------------
let talking: Resident | null = null
let nearby: Resident | null = null
