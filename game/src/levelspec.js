...
export const LEVELS = [
  {
    id: 'L1', name: 'Pahla Din', nameEn: 'First Day',
  ...
  {
    id: 'L7', name: 'Padosi', nameEn: 'Neighbours',
  ...
  {
    id: 'L8', name: 'Subah Ki Nao', nameEn: 'The Dawn Boat',
  ...
  {
    id: 'L9', name: 'School Mein', nameEn: 'At the School',
    district: 'iglesia', opens: [],
    missions: ['school', 'kahani'],        // kahani (new): tell YOUR story back
    blurb: 'Elena wants you to talk to the kids. In Hindi. All of it.',
  },
  {
    id: 'L10', name: 'Fiesta', nameEn: 'The Fiesta',
